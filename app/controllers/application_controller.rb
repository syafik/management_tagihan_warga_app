class ApplicationController < ActionController::Base
  ...
  before_action :action_allowed, only: [:new, :create, :edit, :update], unless: lambda { |controller| controller.request.format.json? }
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: [:uid, :provider, :phone_number, :name])
  end
