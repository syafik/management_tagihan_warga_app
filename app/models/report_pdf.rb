...
class ReportPdf
  ...
  def as_html
    render template: 'cash_transactions/show_report', layout: 'report',
           locals: { report_items: report_items, month: month, year: year, debit_total: debit, credit_total: credit }
  end
end
