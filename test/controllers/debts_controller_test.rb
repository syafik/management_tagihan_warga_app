...
class DebtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post debts_url, params: { debt: { debt_date: @debt.debt_date, debt_type: @debt.debt_type, description: @debt.description, user_id: @debt.user_id, value: @debt.value } }
    end
  ...
  test "should update debt" do
    patch debt_url(@debt), params: { debt: { debt_date: @debt.debt_date, debt_type: @debt.debt_type, description: @debt.description, user_id: @debt.user_id, value: @debt.value } }
