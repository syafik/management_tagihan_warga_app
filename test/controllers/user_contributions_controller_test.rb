...
class UserContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create user_contribution' do
    assert_difference('UserContribution.count') do
      post user_contributions_url,
           params: { user_contribution: { contribution: @user_contribution.contribution,
                                          description: @user_contribution.description, month: @user_contribution.month, pay_at: @user_contribution.pay_at, receiver_id: @user_contribution.receiver_id, user_id: @user_contribution.user_id, year: @user_contribution.year } }
    end
  ...
  test 'should update user_contribution' do
    patch user_contribution_url(@user_contribution),
          params: { user_contribution: { contribution: @user_contribution.contribution,
                                         description: @user_contribution.description, month: @user_contribution.month, pay_at: @user_contribution.pay_at, receiver_id: @user_contribution.receiver_id, user_id: @user_contribution.user_id, year: @user_contribution.year } }
